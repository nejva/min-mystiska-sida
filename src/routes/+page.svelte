...
<main>
  <div>
    ...
    <h1 CLASS="name"> Nova Bettinger </h1>
  ...
  <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
    <path fill="#ADD8E6" d="M29.5,-44C37.1,-41,41.4,-30.9,43.5,-21.3C45.7,-11.7,45.8,-2.5,46.6,8.2C47.5,19,49.1,31.5,43.9,38.7C38.7,45.9,26.6,47.8,14.3,53.8C1.9,59.9,-10.8,70,-18.4,66.2C-26,62.4,-28.6,44.7,-40.2,33.5C-51.8,22.4,-72.5,17.9,-75.7,9.6C-78.8,1.3,-64.3,-10.7,-56.1,-24.3C-47.8,-37.9,-45.8,-53,-37.5,-55.7C-29.2,-58.3,-14.6,-48.4,-1.8,-45.6C10.9,-42.7,21.9,-46.9,29.5,-44Z" transform=" translate(100,70)"  />
  </svg>

</main>

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#b2d8d8" fill-opacity="1" d="M0,192L12.6,170.7C25.3,149,51,107,76,96C101.1,85,126,107,152,133.3C176.8,160,202,192,227,218.7C252.6,245,278,267,303,266.7C328.4,267,354,245,379,202.7C404.2,160,429,96,455,90.7C480,85,505,139,531,170.7C555.8,203,581,213,606,202.7C631.6,192,657,160,682,144C707.4,128,733,128,758,117.3C783.2,107,808,85,834,74.7C858.9,64,884,64,909,80C934.7,96,960,128,985,160C1010.5,192,1036,224,1061,240C1086.3,256,1112,256,1137,234.7C1162.1,213,1187,171,1213,160C1237.9,149,1263,171,1288,197.3C1313.7,224,1339,256,1364,245.3C1389.5,235,1415,181,1427,154.7L1440,128L1440,320L1427.4,320C1414.7,320,1389,320,1364,320C1338.9,320,1314,320,1288,320C1263.2,320,1238,320,1213,320C1187.4,320,1162,320,1137,320C1111.6,320,1086,320,1061,320C1035.8,320,1011,320,985,320C960,320,935,320,909,320C884.2,320,859,320,834,320C808.4,320,783,320,758,320C732.6,320,707,320,682,320C656.8,320,632,320,606,320C581.1,320,556,320,531,320C505.3,320,480,320,455,320C429.5,320,404,320,379,320C353.7,320,328,320,303,320C277.9,320,253,320,227,320C202.1,320,177,320,152,320C126.3,320,101,320,76,320C50.5,320,25,320,13,320L0,320Z"></path></svg>
